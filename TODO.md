...
> **Remaining 18.8 sub-items (not yet carved/done):** 18.8b admin "Robot Runs" screen UI (visual); 18.8c price-alerts log route+screen; 18.8d AI chat-logs log (depends on 18.7 assistant). The Deposits/Withdrawals admin **screen UIs** (consuming the 18.8e/18.8f slices above) are visual sub-items. Each should be its own bounded item.
