...
- [ ] Per §2 of the design doc. Behaviour-preserving defaults (default `standard` group: 0 markup, 100x, 0% stop-out). **Acceptance:** migration file present; client+server tsc clean; backfill assigns every existing account to the default group.
